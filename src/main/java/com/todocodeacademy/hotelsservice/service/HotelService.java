...
public class HotelService implements IHotelService {
    ...
    List<Hotel> hotelsList = new ArrayList<>();// habia puesto hotelCityList
    ...
    public List<Hotel> getHotelsByCityId(Long idCity) {
        ...
        // cargamos la BD "Logica"
        this.loadHotels();
        // Se busca si coincide la id
        for (Hotel h : hotelsList) {
            if (h.getIdCity() == idCity) {
                hotelCityList.add(h);
            }
